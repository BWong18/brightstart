...
public class TimetableActivity extends AppCompatActivity {
    ...
    private ImageView backButton, signoutButton, notification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set up back button click listener to navigate back to DashboardActivity
    ...
    private boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.navigation_home) {
            Intent homeIntent = new Intent(TimetableActivity.this, DashboardActivity.class);
            startActivity(homeIntent);
            finish();
            return true;
        } else if (itemId == R.id.navigation_chat) {
            startActivity(new Intent(TimetableActivity.this, ChatActivity.class));
            return true;
        } else if (itemId == R.id.navigation_profile) {
            Intent profileIntent = new Intent(TimetableActivity.this, NavigationProfile.class);
    ...
    // Simulate a function to get timetable based on the current day
    ...
    private void openActivity(Class<?> activityClass) {
        Intent intent = new Intent(TimetableActivity.this, activityClass);
        startActivity(intent);
    }

    private void signOutUser() {
        FirebaseAuth.getInstance().signOut(); // Sign out from Firebase Auth
        Intent intent = new Intent(TimetableActivity.this, LoginActivity.class); // Navigate to login screen
